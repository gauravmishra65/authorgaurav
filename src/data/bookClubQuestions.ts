// Single source of truth for Offbeat Love's book-club discussion questions,
// shared between BookDetail.tsx and BookClubs.tsx so they can't drift out
// of sync. The downloadable public/resources/book-club-questions-offbeat-love.txt
// mirrors this list manually — update it too if these questions change.
export const offbeatLoveBookClubQuestions = [
