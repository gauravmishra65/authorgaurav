    ...
    <>
      ...
      <section className="bg-ink text-ivory paper-grain">
        ...
        <div className="mx-auto max-w-5xl px-6 py-20 text-center">
          ...
          <p className="text-ivory/75 max-w-2xl mx-auto leading-relaxed">
            From romance to thriller to memoir to devotion — six works that share one
            belief: a good story can carry a reader anywhere.
          </p>
        </div>
      </section>
                ...
                >
                  ...
                  <div>
                    <div className="flex items-center gap-3 flex-wrap mb-2">
                      ...
                      {b.isHindi && (
                        <span className="label-caps text-2xs text-rose border border-rose/40 rounded-full px-2.5 py-0.5">
                          Hindi
                        </span>
                      )}
                    </div>
                    <p className="font-body italic text-muted mb-4">{b.tagline}</p>
                    <p className="text-text/85 leading-relaxed max-w-prose mb-6">
                      {b.synopsis}
                    </p>
                    ...
                    <div className="flex flex-wrap gap-3 mb-4">
                      {b.buyLinks.map((link) => (
                        <a
                          key={link.label}
                          href={link.href}
                          className="btn-caps btn-gold-outline rounded-sm px-4 py-2 text-2xs"
                        >
                          {link.label}
                        </a>
                      ))}
                    ...
                    {b.bookWebsite && (
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 label-caps text-gold hover:text-ink transition-colors"
                      >
                        Book Website
      ...
      <section className="mx-auto max-w-4xl px-6 py-16 text-center">
        ...
        <p className="text-muted mb-7 max-w-lg mx-auto">
          Get a free chapter delivered to your inbox — and a note when the next book
          arrives.
        </p>
        <Link
          to="/contact"
