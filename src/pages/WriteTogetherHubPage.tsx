    ...
    <>
      ...
      <section className="bg-ink text-ivory paper-grain">
        ...
        <div className="mx-auto max-w-5xl px-6 py-20 text-center">
          <span className="inline-block rounded-full border border-gold/40 px-4 py-1.5 label-caps text-gold-lt mb-5">
            A Home for Writers
          </span>
          ...
          <p className="text-ivory/80 max-w-2xl mx-auto leading-relaxed mb-8">
            I built WriteTogetherHub to give writers and newcomers what I wished I’d had
            starting out — guidance, community, and a place to grow their craft together.
          </p>
          <a
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {benefits.map((b) => (
            <div
              key={b.title}
              className="rounded-md border border-gold/20 bg-cream p-7 text-center shadow-luxury transition-all hover:-translate-y-1"
            >
      ...
      <section className="bg-cream paper-grain">
        <div className="mx-auto max-w-prose px-6 py-16">
          ...
          <p className="text-text/85 leading-relaxed text-center">
            I remember what it felt like to start out — the uncertainty, the isolation,
            the gap between what I could imagine and what I could put on the page.
            WriteTogetherHub exists to close that gap, for the writer I was and the
            writers I hope to meet.
          </p>
        </div>
      </section>

      <EmailStrip
        heading="Join the writer’s letter"
        subheading="Craft notes, community updates, and early calls to join WriteTogetherHub."
      />
