...
export default function AnnouncementBar() {
  ...
  return (
    <div role="region" aria-label="Site announcement" className="bg-ink text-ivory text-2xs sm:text-xs">
      <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-center gap-x-3 gap-y-1 px-6 py-2 text-center">
        ...
        <Link to={activeAnnouncement.ctaHref} className="label-caps inline-flex items-center gap-1 text-gold-lt hover:text-gold-text transition-colors whitespace-nowrap">
